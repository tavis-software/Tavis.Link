    ...
    public class UriTemplateTests2
    {
            ...
            get
            {
                ...
                stream =
                    typeof (UriTemplateTests2).Assembly.GetManifestResourceStream(
                        "LinkTests.uritemplate_test.spec-examples.json");
                suites.Add(CreateTestSuite(new StreamReader(stream).ReadToEnd()));

                stream = typeof(UriTemplateTests2).Assembly.GetManifestResourceStream("LinkTests.uritemplate_test.spec-examples-by-section.json");
                suites.Add(CreateTestSuite(new StreamReader(stream).ReadToEnd()));
        ...
        public static IEnumerable<object[]> ExtendedSamples
        {
            get
            {
                ...
                stream =
                    typeof(UriTemplateTests2).Assembly.GetManifestResourceStream(
                        "LinkTests.uritemplate_test.extended-tests.json");
                suites.Add(CreateTestSuite(new StreamReader(stream).ReadToEnd()));
        ...
        public static IEnumerable<object[]> FailureSamples
        {
            get
            {
                ...
                stream =
                    typeof(UriTemplateTests2).Assembly.GetManifestResourceStream(
                        "LinkTests.uritemplate_test.negative-tests.json");
                suites.Add(CreateTestSuite(new StreamReader(stream).ReadToEnd()));
